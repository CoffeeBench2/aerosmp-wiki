...
**Create: Aeronautics** is the reason this server exists. You design a ship, you
build it, and then you actually fly it — real physics, not a decorated boat.

---

## Building one

Build it on the ground first, as a normal structure, then assemble it. Once
...
> Get this backwards and you lose the claim.
>
> A ship claim is bound to the ship's internal ID. If you pick the ship up with a
> **portable structure item** and place it again, it gets a **new ID** — the old
> claim is orphaned, your ship is unprotected, and the claim you spent is wasted.
>
> **Once a ship is claimed, stop capturing it.**
...
## Flying over other people's land

Land claims are **full-height columns**. Flying over someone's claimed chunk puts
you inside their claim, at any altitude, and you won't be able to interact with
your own ship while you're there.
...
- **Test small.** Assemble something tiny first and learn the controls before
  committing to a build you've spent hours on
