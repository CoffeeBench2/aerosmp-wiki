...
|---|---|
| `/shipname <name>` | Name the ship you're standing on |
| `/shipname info` | Show the current name |
| `/shipname clear` | Remove the name |

See [[airships]] and [[claims]].
...
Run these in the server's Discord, not in-game:
